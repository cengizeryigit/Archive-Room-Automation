...
{
    public partial class UpdateShelf : Form
    {
        public UpdateShelf()
        {
            InitializeComponent();
        ...
        private void UpdateShelf_Load(object sender, EventArgs e)
        {
        ...
        private void UpdateShelfButton_Click(object sender, EventArgs e)
        {
            SqlCommand komut;
            string sql = "update raftablosu Set raf_adi='" + UpdateShelfTextBox.Text + "' where raf_id='" + ShelfComboBox.SelectedValue + "'";
            komut = new SqlCommand();
            Crud.ESG(sql, komut);
            UpdateShelfTextBox.Text = "";
