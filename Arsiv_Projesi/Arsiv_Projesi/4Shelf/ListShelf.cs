...
{
    public partial class ListShelf : Form
    {
        public ListShelf()
        {
            InitializeComponent();
        ...
        private void ListShelf_Load(object sender, EventArgs e)
        {
            ...
            ArchiveDataGridView.DataSource = Crud.List("Select raf_id,raf_adi,bolum_adi from raftablosu inner join bolumtablosu ON raftablosu.bolum_id=bolumtablosu.bolum_id");
        ...
        private void ListShelfButton_Click(object sender, EventArgs e)
        {
            int val;
            Int32.TryParse(SectionComboBox.SelectedValue.ToString(), out val);

            ArchiveDataGridView.DataSource = Crud.List("Select raf_id,raf_adi,bolum_adi from raftablosu inner join bolumtablosu ON raftablosu.bolum_id=bolumtablosu.bolum_id Where bolumtablosu.bolum_id=" + val);
        }
    }
}
