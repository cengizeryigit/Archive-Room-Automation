...
namespace Arsiv_Projesi._6File
{
    public partial class SearchFile : Form
    {
        ...
        {
            ArchiveDataGridView.DataSource = Crud.List("Select dosya_adi,klasor_adi from dosyatablosu inner join klasortablosu ON dosyatablosu.klasor_id=klasortablosu.klasor_id where dosya_adi like '%" + SearchFileTextBox.Text + "%'");
