...
namespace Arsiv_Projesi._6File
{
    public partial class ListFile : Form
    {
        ...
        private void ListFile_Load(object sender, EventArgs e)
        {
            ...
            ArchiveDataGridView.DataSource = Crud.List("Select dosya_id,dosya_adi,klasor_adi from dosyatablosu inner join klasortablosu ON dosyatablosu.klasor_id=klasortablosu.klasor_id");
        ...
        private void ListFileButton_Click(object sender, EventArgs e)
        {
            int val;
            Int32.TryParse(FolderComboBox.SelectedValue.ToString(), out val);

            ArchiveDataGridView.DataSource = Crud.List("Select dosya_id, dosya_adi,klasor_adi from dosyatablosu inner join klasortablosu ON dosyatablosu.klasor_id=klasortablosu.klasor_id Where dosyatablosu.klasor_id=" + val);
