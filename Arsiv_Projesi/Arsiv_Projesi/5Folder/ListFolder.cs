...
{
    public partial class ListFolder : Form
    {
        public ListFolder()
        {
            InitializeComponent();
        ...
        private void ListFolder_Load(object sender, EventArgs e)
        {
            ...
            ArchiveDataGridView.DataSource = Crud.List("Select klasor_id, klasor_adi,raf_adi from klasortablosu inner join raftablosu ON klasortablosu.raf_id=raftablosu.raf_id");
        ...
        private void ListFolderButton_Click(object sender, EventArgs e)
        {
            int val;
            Int32.TryParse(ShelfComboBox.SelectedValue.ToString(), out val);

            ArchiveDataGridView.DataSource = Crud.List("Select klasor_id, klasor_adi,raf_adi from klasortablosu inner join raftablosu ON klasortablosu.raf_id=raftablosu.raf_id Where klasortablosu.raf_id="+ val);
