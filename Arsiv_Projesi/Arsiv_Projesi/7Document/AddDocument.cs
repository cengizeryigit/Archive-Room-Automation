...
namespace Arsiv_Projesi._7Document
{
    public partial class AddDocument : Form
    {
        ...
        private void AddDocument_Load(object sender, EventArgs e)
        {
            ...
            DocumentStateComboBox.DataSource = Crud.List("Select gelengidenevrak_id,gelengidenevrak_adi from gelengidenevraktablosu");
            DocumentStateComboBox.ValueMember = "gelengidenevrak_id";
            DocumentStateComboBox.DisplayMember = "gelengidenevrak_adi";
        }
        ...
        private void AddDocumentButton_Click(object sender, EventArgs e)
        {
            ...
            Int32.TryParse(FileComboBox.SelectedValue.ToString(), out val);
            int val2;
            Int32.TryParse(DocumentStateComboBox.SelectedValue.ToString(), out val2);
            SqlCommand komut;
            string sql = "insert into evraktablosu(evrak_adi,evrak_islem_tarihi,dosya_id,gelengidenevrak_id) values('" + AddDocumentTextBox.Text + "','" + DateTime.Now.ToString() +  "' ,"+ val+"," +val2+")";
            komut = new SqlCommand();
            Crud.ESG(sql, komut);


            AddDocumentTextBox.Text = "";
            DocumentComboBox.Text = "";         
            string komut2 = "Select evrak_id,evrak_adi from evraktablosu where dosya_id =" + val;
            DocumentComboBox.DataSource = Crud.List(komut2);
            DocumentComboBox.ValueMember = "evrak_id";
            DocumentComboBox.DisplayMember = "evrak_adi";
