...
namespace Arsiv_Projesi._7Document
{
    public partial class UpdateDocument : Form
    {
        ...
        private void UpdateDocumentButton_Click(object sender, EventArgs e)
        {
            SqlCommand komut;
            string sql = "update klasortablosu Set klasor_adi='" + UpdateDocumentTextBox.Text + "' where klasor_id='" + DocumentComboBox.SelectedValue + "'";
